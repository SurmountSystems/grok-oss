...
use super::setters::{
    ...
    set_hide_header_inner, set_hide_title_bar_inner, set_hunk_tracker_mode_inner,
...
pub(in crate::app::dispatch) fn action_for_reset(
    ...
    match (key, value) {
        ...
        ("hide_title_bar", SettingValue::Bool(b)) => Some(Action::SetHideTitleBar(*b)),
...
pub(in crate::app::dispatch) fn apply_setting_rollback(
    ...
    match (key, rollback_value) {
        ...
        ("hide_title_bar", SettingValue::Bool(b)) => set_hide_title_bar_inner(app, *b),
