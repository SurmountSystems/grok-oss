...
Learn how to install, configure, and extend **Grok OSS** (`grok-oss`), Surmount's unofficial open-source fork of SpaceXAI Grok Build. Config and sessions still live under `~/.grok`. This is not affiliated with xAI.
...
| 2 | [Authentication](02-authentication.md) | Browser login, API keys, SuperGrok vs console, `/limits`, OIDC/SSO, and device-code flow |
...
Customize and extend Grok OSS.

| # | Document | Description |
|---|----------|-------------|
| 6 | [Theming and Appearance](06-theming.md) | DOGE default theme, window titles vs hide header, `/theme`, and `pager.toml` |
...
Automate, script, and integrate Grok OSS with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `grok-oss -p`, output formats, CI/CD integration, and piping |
