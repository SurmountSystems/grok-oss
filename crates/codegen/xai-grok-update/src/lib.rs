...
pub use rebuild::{
    ...
    RebuildReport, backup_previous_grok_oss_binary, cargo_sub_fraction, clamp_rebuild_fraction,
    collect_rebuild_signal_pids, export_git_index_to, format_rebuild_cli_progress,
    git_work_tree_is_present, install_stdio_policy, is_cargo_json_build_finished,
    ...
    rebuild_and_relaunch, rebuild_and_relaunch_with_progress, rebuild_progress_bar_chars,
    rebuild_progress_weights, rebuild_relaunch_request_path, resolve_source_root, run_install,
    run_install_with_progress, running_exe_needs_relaunch_onto, sanitize_rebuild_progress_line,
